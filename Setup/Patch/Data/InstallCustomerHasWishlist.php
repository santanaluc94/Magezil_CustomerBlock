...
/**
 * Class InstallCustomerHasWishlist
 *
 * @category Magento
 ...
 */
class InstallCustomerHasWishlist implements DataPatchInterface, PatchVersionInterface, PatchRevertableInterface
{
    private const ATTR_NAME = "has_wishlist";
